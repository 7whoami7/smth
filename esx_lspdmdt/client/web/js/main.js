$(document).ready(function () {
                ...
                for (let key in data.Police) {
                    ...
                    $('#onduty-info').append(
                        `<div class='default-duty-info' style='margin-top: 8px;'>
                            <div class='duty-who'>[${data.Police[key].odznaka}] ${data.Police[key].firstname + ' ' + data.Police[key].lastname}</div>
    ...
    $(document).on ("click", "#file-content-removemandat", function() {
        ...
        $.post('http://esx_lspdmdt/RemoveMandatKartoteka', JSON.stringify({id: id, charid: charid}));
        $(this).parent().fadeOut(500);
    });
    ...
    $(document).on ("click", "#file-content-removeposzukiwania", function() {
        ...
        $.post('http://esx_lspdmdt/RemovePoszukiwaniaKartoteka', JSON.stringify({charid: charid, reason: reason}));
        console.log(reason)
        $(this).parent().fadeOut(500);
    });
    ...
    $(document).on ("click", "#file-content-removenotatki", function() {
        ...
        $.post('http://esx_lspdmdt/RemoveNotatkiKartoteka', JSON.stringify({charid: charid, note: note}));
        $(this).parent().fadeOut(500);
    });
    ...
    $(document).on ("click", "#file-more-info", function (event) {
        ...
        $.post('http://esx_lspdmdt/PersonMoreInfo', JSON.stringify({charid: charid}), function(moreinfodata){
    ...
    $('#file-button-search').on('click', function(){
        ...
        if(reasonarea != "") {
            ...
            $.post('http://esx_lspdmdt/AddPoszukiwaniaKartoteka', JSON.stringify({charid: charid, reasonarea: reasonarea}), function(poszukiwaniadata){
                $('.moreinfo-poszukiwania').append(
                    `<div class="file-content-holder" style="margin-top: 0.5%;">
    ...
    $('#file-button-notes').on('click', function(){
        ...
        if (note != "") {
            ...
            $.post('http://esx_lspdmdt/AddNotatkaKartoteka', JSON.stringify({charid: charid, note: note}), function(notedata){
                $('.moreinfo-notatki').append(
                    `<div class="file-content-holder" style="margin-top: 0.5%;">
                ...
                $('.file-holder-content').append(`
                    <div class="file-holder-info" style="margin-top: 1%; margin-bottom: 0.5%; border-radius: 0px; height: 50px;">
                        <div class="file-who">
                            ...
                            <span id="file-name" data-charid="${persondata[key].charid}">${persondata[key].firstname} ${persondata[key].lastname}</span>
                        </div> 
